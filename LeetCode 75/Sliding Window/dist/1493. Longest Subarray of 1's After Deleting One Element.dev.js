...
function longestSubarray(nums) {
  var maxLength = 0; // To store the maximum length of subarray with 1's

  var count = 0; // To count the number of 1's

  var deleted = 0; // To track if an element has been deleted
  ...
  if (nums[nums.length - 1] === 1 && deleted === 1) {
    maxLength--;
  }
